...
def main_program():
    ...
    for data_file in data_files:
        ...
        gender_print = "{} ==> GENDER(lstm): {} gender_prob: {}".format(
            data_file, get_gender(gender_predict).upper(), gender_predict)
        age_print = "{} ==> AGE(lstm): {} age_prob: {}".format(
            data_file, get_age(age_predict).upper(), age_predict)
